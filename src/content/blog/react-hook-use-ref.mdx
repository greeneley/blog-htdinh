...
**Update 02/01/2025**: Từ phiên bản React19, chúng ta có thể truy cập ref như một props của component. Do đó `forwardRef` đã deprecated và trong tương lai sẽ được xóa.